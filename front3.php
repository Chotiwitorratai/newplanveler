    ...
    <script type="text/javascript">
        function saveLocation() {
            ...
            // เมื่อ submit form id myform1    
                $("#motherfucker").on("submit", function() {

                        // เก็บชุดข้อมูลที่ต้องการส่งทั้งหมดไว้ในตัวแปร str
                        var str = $("#motherfucker").serialize();
                        $.post("insert8.php", str, function(data) { // ส่งข้อมูลแบบ post 
...
<body onclick="closeNav()">
    ...
    <form method="post" action="insert8.php" name="motherfucker" enctype="multipart/form-data">
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" id="location_detail" name="location_detail<?php echo $i; ?>" placeholder="รายละเอียด">
                                <!-- <textarea rows="4" cols="auto" id="location_detail" name="location_detail<?php echo $i; ?>" form="usrform">
                </textarea> -->
                            </div>
                        </div>
