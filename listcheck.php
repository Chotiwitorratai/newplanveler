...
<body>
    ...
    $strSQL = "SELECT time_created,trip_name,location_name,location_detail,image_name,image_trip_name,time_use,time_travel FROM tbl_location  where(trip_name) in (select trip_name from tbl_location group by trip_name having count(trip_name) >='2' ) 
    ...
    <table width="600" border="1">
        <tr>
            ...
            <th width="98" hight="100">
                <div align="center">image_trip_name </div>
            </th>
        ...
        ?>
            <tr>
                ...
                <td><?php echo '<img src="images/'.$objResult['image_trip_name'] .'" height="200" width="200" class="img-thumnail" />' ?></td>
