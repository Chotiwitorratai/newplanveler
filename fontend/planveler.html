...
<div class="inside">
  ...
  <div id="container"style="position:relative;margin-left:50px;margin-top:150px;color: #1C3C25;">
    <h1>What’s planveler ?</h1>
    <br>
    <div id="container">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Planveler เว็บไซต์ของการจัดทริปท่องเที่ยว ที่รวบรวมทริปเที่ยวที่หลากหลายไว้มากมาย ด้วยการนำเสนอเนื้อหาและข้อมูลอย่างเข้าใจง่ายจากจากทีมงานและผู้ใช้จริงอย่างครบวงจร ทั้งจำนวนวันที่ต้อง
      การจะไปเที่ยวจำนวนงบประมาณ สถานที่ท่องเที่ยวที่เรียบเรียงไว่อย่างน่าสนใจ เข้าใจง่ายผ่านเว็บไซต์ของ Planveler โดยสามารถทำการดูทริปที่น่าสนใจ ทริปที่ยอดนิยม รวมทั้งสามารถสร้างทริปหรือ
      แก้ไขทริปที่มีอยู่แล้วเห็นเป็นแบบฉบับของตัวเองได้และสามารถเปลี่ยนทริป ของผู้ใช้ท่านอื่นได้ และสามารถแบ่งปันให้กับผู้ใช้ท่านอื่นๆให้สามารถมาดูทริปที่เราสร้างไว้ได้อีกด้วย
    </div>
    </div>
  </div>
  </div>
