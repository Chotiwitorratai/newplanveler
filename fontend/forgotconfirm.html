...
<body onclick="closeNav()">
    ...
    <div class="container confirmbox">
        <div class="confirm-header">
            รหัสผ่านกำลังถูกส่งไปยัง email ของคุณ
        </div>
        <div class="confirm-content">
            ส่งรหัสผ่านไปทาง <br>
            <div class="confirm-email">
                <a href="#">Aomsin_s15@kmitl.ac.th</a>
            </div>
            <div class="confirm-img">
                <img src="/pic/TK_03013 5.png">
            </div>
            <div class="confirm-username">
                Aomsin_s15
            </div>
        </div>
        <div class="confirmbtu">
            <input type="button" value="ดำเนินการต่อ">
        </div>
    </div>
