...
<body onclick="closeNav()">
    ...
    <div class="header-trip">
        <form action="/action_page.php"><input type="text" id="header-trip" placeholder="ตั้งชื่อทริป"></form>
    </div>
    <div class="daytrip">
        <br>Day<br>
        <br>
    ...
    <div class="container justify-content-center tripblock" id="1 tripblock">
        ...
        <div id="edit-trip" style="display:none;">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input type="text" name="trip-place" placeholder="เพิ่มสถานที่">
            ...
            <div class="row detail">
                <div class="col">
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                          <img src="http://lorempixel.com/75/50/abstract/">
                          0123 4567 8912 3456
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li>
                            <a href="#" title="Select this card"><img src="/pic/model1.png"></a>
                          </li>
                          <li>
