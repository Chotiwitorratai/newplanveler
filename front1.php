...
<body onclick="closeNav()">
    ...
    <form method="post" action="insert6.php" enctype="multipart/form-data">
                            ...
                            <div class="col-5">
                                <div class="addimgtrip">
                                    <div class="addimgtrip-text">เพิ่มรูปภาพ
                                        ...
                                        <input type="file" id="image_file" name="image_file<?php echo $i; ?>" class="inputfile" onchange="readURL(this);">
