...
<body onclick="closeNav()">
  ...
  <div class="container emp-profile" id="Profileedit">
    <form method="post" >
      ...
      <div class="profile-edit-btn"input type="submit" name="submit" value="Edit Profile"><a href="frontuseredit1.php?username=<?php echo $_SESSION["username"]; ?>">Edit Profile</a></div>
